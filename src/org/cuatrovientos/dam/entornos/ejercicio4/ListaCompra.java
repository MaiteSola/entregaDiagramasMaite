...
public class  ListaCompra extends Usuario {
	...
	public void verProductos() {
		//TODO implentar. Con un for each imprimir todos los productos de la lista y sus cantidades.
	}
	
	public void tacharProducto(String nombre) {
		//TODO implementar: Con un equals buscar el producto a tachar en un for each y cambiar su estado de producto.
	}
